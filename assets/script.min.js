...
function remove(el){d('DELETE','/u/del/'+el.getAttribute('data-link')+'?token='+t,null,function(){var response=JSON.parse(this.responseText)
...
for(var i=0;i<el_delete.length;i++){el_delete[i].onclick=function(){remove(this)}}}
